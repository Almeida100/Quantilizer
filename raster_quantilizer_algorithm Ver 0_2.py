...
class RasterQuantilizerAlgorithm(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        param.setFlags(param.flags() | QgsProcessingParameterDefinition.FlagAdvanced)
        self.addParameter(param)         
        param = (QgsProcessingParameterNumber('Class5ULP', 'Class5 Upper Limit Percentile (Allways = 100)', type=QgsProcessingParameterNumber.Integer, minValue=100, maxValue=100, defaultValue=100))
        param.setFlags(param.flags() | QgsProcessingParameterDefinition.FlagAdvanced)
        self.addParameter(param)          
