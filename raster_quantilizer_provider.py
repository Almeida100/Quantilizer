...
from .raster_quantilizer_algorithm import RasterQuantilizerAlgorithm


class RasterQuantilizerProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(RasterQuantilizerAlgorithm())
